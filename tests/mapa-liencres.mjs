...
const j = JSON.parse(readFileSync('tests/ola-liencres.json', 'utf8'));
...
<div id="m"></div><div class="tit">\u{1f30a} Ola perfecta · Liencres — Playa del Madero — Hs offshore ${j.Hs0} m · T ${j.T0} s — puntos rojos = rompe</div>
...
await (await import('fs')).promises.writeFile('tests/ola-liencres.html', html);
